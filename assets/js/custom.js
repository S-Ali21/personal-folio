...
$("#status").fadeOut(), $("#preloader").delay(350).fadeOut("slow"), $("body").delay(350).css({
    ...
    $(window).scrollTop() >= 200 ? $(".sticky").addClass("stickyadd") : $(".sticky").removeClass("stickyadd")
...
//   cards.attr("style", "transform: rotateY("+ax+"deg) rotateX("+ay+"deg);-webkit-transform: rotateY("+ax+"deg) rotateX("+ay+"deg);-moz-transform: rotateY("+ax+"deg) rotateX("+ay+"deg)");
// });
